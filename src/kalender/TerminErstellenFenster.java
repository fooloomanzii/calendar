...
public class TerminErstellenFenster extends JDialog {
	...
	/*public static void main(String[] args) {
		try {
			TerminErstellenFenster dialog = new TerminErstellenFenster();
	 ...
	 * Create the dialog.
	 */
	public TerminErstellenFenster(final Person angemeldet) {
