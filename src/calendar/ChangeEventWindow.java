...
public class ChangeEventWindow extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ChangeEventWindow(final Event meeting) {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(title.equals("") || dateFrom.equals("") || dateTo.equals("") || timeFrom.equals("") || timeTo.equals("")){
					...
					if (repeat.equals("Unique")){
						Event.changeMeeting(meeting, title, dateFrom, dateTo, timeFrom, timeTo, location, description, repeat, repeatTo, visibility);
						dispose();
					}
