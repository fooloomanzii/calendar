...
public class Event{
	 ...
	 * Konstruktor
	 */
    public Event(String owner, String title, String dateFrom, String dateTo, String timeFrom, String timeTo, 
     ...
     */
    public static void createMeeting(Client owner, String title, String dateFrom, String dateTo, String timeFrom, 
     ...
     */
    public static void changeMeeting(Event termin, String title, String dateFrom, String dateTo, 
	...
	public static ArrayList<Event> getMeetingList(String mail){
		...
		try{
			...
			while (rs.next()){
				Event me = new Event(rs.getString("owner"), rs.getString("title"),rs.getString("dateFrom"),
